...
extern EMB_PUBLIC void EMB_CALL embPattern_addObject(EmbPattern* p, EmbObject* obj);
extern EMB_PUBLIC void EMB_CALL embPattern_addObjectList(EmbPattern* p, EmbObjectList* pointer);
